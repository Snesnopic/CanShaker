...
class Achievement: Identifiable{
    ...
    static func ensureAchievementsExist(context:ModelContext, achievements:[Achievement]) {
        if achievements.isEmpty {
            do{
                let list = [
                    Achievement(title: String(localized: "Heroic Shaker"), subTitle: String(localized: "Master of Motion"), desc: String(localized: "You've shaken your can over 1000 times! Keep it up!"), completion: 0, isAchieved: false, imageName: "emptyCan"),
                    ...
                    Achievement(title: String(localized: "Master of Energy"), subTitle: String(localized: "Heartbeats, Calories, Speed!"), desc: String(localized: "You've achieved a perfect score on all metrics: heartbeats, burned calories, and speed!"), completion: 0, isAchieved: false, imageName: "1st")
                ]
