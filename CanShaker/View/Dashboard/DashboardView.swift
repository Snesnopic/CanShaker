    ...
    var body: some View {
        NavigationStack{
                ...
                VStack{
                    ...
                    LastSessionView(feedbackToGive: Feedback(sentence: "It looks like we have a marathon runner here!", type: .compliment, category: .speed, condition: .low, imageName: "bolt.fill"))
