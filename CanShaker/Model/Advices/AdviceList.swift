...
extension Advice {
    static let list = [
        ...
        Advice(title: "Lube up your can for comfort", description: "Using a water-based lubricant during the shaking can help reduce friction and irritation of the can. This is especially important if you're prone to dryness or sensitivity. Avoid using products like lotions, oils, or creams that may contain ingredients that could irritate the delicate skin of your poor can.", category: .hygiene),
        Advice(title: "Post shake hygiene", description: "Like any utensil, clean it after usage, gently wash the shaking area with warm water and a mild, unscented soap to remove any remaining lubricant or spray. Be sure to rinse thoroughly and pat dry with a clean towel. Keeping the shaking area clean helps prevent the buildup of bacteria and reduces the risk of skin irritation or infection.", category: .hygiene),
        //
        //let's separate for visibility and filtering by category
        //
        Advice(title: "Slow Down", description: "Rushing to climax often leads to a brief peak followed by a quick decline. Taking your time to build up gradually results in more intense artwork.", category: .methods),
        Advice(title: "Try Edging", description: "Practice holding back when nearing climax of your inspiration, then resume stimulation. Repeating this pattern enhances artwork output intensity and duration.", category: .methods),
        ...
        //let's separate for visibility and filtering by category
        //
        Advice(title: "Hurting yourself", description: "If you start feeling hurt or you feel your can is dry, it is a great sign that you should stop painting.", category: .safety),
        ...
        Advice(title: "Quiet place", description: "Find a quiet, private area where you won't be disturbed or interrupted. Nobody likes doing graffiti when cops are around. Interruptions can cause instability during your experience and may lead to unpleasent discoveries", category: .safety),
    ]
}
