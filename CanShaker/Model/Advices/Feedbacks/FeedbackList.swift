...
extension Feedback {
    static let list = [
        ...
        Feedback(sentence: "Ever heard of 'Achille and the tortoise'? Guess who you are.", type: .insult, category: .duration, condition: .low, imageName: "figure.run"),
        ...
        Feedback(sentence: "Are you still watching?", type: .compliment, category: .duration, condition: .high, imageName: "figure.run"),
        ...
        Feedback(sentence: "Impressive dedication to the craft, my friend.", type: .insult, category: .heartBeat, condition: .low, imageName: "heart.fill"),
        ...
        Feedback(sentence: "Oh so that's why you got the gym membership!", type: .insult, category: .calories, condition: .low, imageName: "flame.fill"),
        ...
        Feedback(sentence: "Oh so that's why you got the gym membership!", type: .compliment, category: .calories, condition: .high, imageName: "flame.fill"),
        
        //MARK: ACCEL
        //low
        Feedback(sentence: "Slow and steady wins the race.", type: .insult, category: .accel, condition: .low, imageName: "bolt.fill"),
        Feedback(sentence: "Was that a funeral procession? Oh, you missed it for how slow you were.", type: .insult, category: .accel, condition: .low, imageName: "bolt.fill"),
        ...
        Feedback(sentence: "'Deja vù! I've just  been in this place before'", type: .compliment, category: .accel, condition: .high, imageName: "bolt.fill"),
